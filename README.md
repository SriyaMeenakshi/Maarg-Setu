...
# 🛣️ MAARG SETU - Smart Road Safety Intervention Cost Estimator
...
│
├── estimator_helper.py              # Core estimation engine (modular functions)
...
### Core Functions (`estimator_helper.py`)
...
**Team Name:** Dharma Driven  
**Created by** Sriya Meenakshi Chalamalasetty
**Contact:** chsriyameenu2818@gmail.com
